...
_TILE_SPECS: list[tuple[str, str]] = [
    ("revenue", "Revenue (12 mo)"),
    ("expenses", "Expenses (12 mo)"),
...
class DashboardView(QWidget):
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        for key, caption in _TILE_SPECS:
            frame, value_label = self._make_tile(caption)
    ...
    @staticmethod
    def _make_tile(caption: str) -> tuple[QFrame, QLabel]:
    ...
    def load(self, client: APIClient | None = None) -> None:
        ...
        try:
            ...
            model = build_dashboard_model(self._client, today)
